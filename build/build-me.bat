...
@REM ===============================
@REM Boost Install
@set Boost_DIR=C:\local\Boost_1_62_0
...
@echo Set ENV Boost_DIR=%Boost_DIR% 
@echo Set ENV Boost_DIR=%Boost_DIR% >> %TMPLOG%
...
@REM ##############################################
@if %ADDINST% EQU 1 goto ADDINST
@echo Install not conifigured at this time! Set ADDINST=1
@echo.
@goto END
...
:NOBOOST
@echo Can NOT locate %Boost_DIR%! *** FIX ME ***
@goto ISERR
